...
public class Progressive
{
    ...
    public void Winner()
    {
        var algorithm = new ProcentProgressiveAlgorithm(1000, 10);
    ...
    [TestCase(20)]
    [TestCase(30)]
    public void ProcentProgressiveAlgorithm(int players)
    {
    ...
    {
        var algorithm = new ProcentProgressiveAlgorithm(1000, players);
